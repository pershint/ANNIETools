...
def EstimateNeutronEfficiency(Sdf, Sdf_trig):
    ...
    print("SINGLE PULSE CLUSTER COUNT: %s"%(str(Sdf_SinglePulses.size)))
    Sdf_ChargeCut = es.SiPMChargeCut(Sdf_SinglePulses,0.1,0.5)
    print("SINGLE PULSE + CHARGE CUT CLUSTER COUNT: %s"%(str(Sdf_ChargeCut.size)))
    Sdf_CleanPrompt = es.NoPromptClusters(Sdf_ChargeCut,SIGNAL_WINDOW_START)
    ...
    print("SINGLE PULSE TRIG COUNT: %s"%(str(Sdf_trig_SinglePulses.size)))
    Sdf_trig_ChargeCut = es.SiPMChargeCut(Sdf_trig_SinglePulses,0.1,0.5)
    print("SINGLE PULSE + CHARGE CUT TRIG COUNT: %s"%(str(Sdf_trig_ChargeCut.size)))
    Sdf_trig_CleanPrompt = es.NoPromptClusters_WholeFile(Sdf_ChargeCut,Sdf_trig_ChargeCut,2000)
