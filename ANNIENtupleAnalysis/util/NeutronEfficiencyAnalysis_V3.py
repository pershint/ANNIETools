...
NEffRanges = {'Position 0': np.arange(0.70,0.80,0.01), 'Position 1': np.arange(0.52,0.61,0.01),
        'Position 2': np.arange(0.42, 0.50, 0.01), 'Position 3': np.arange(0.32,0.40, 0.01)}
GEffRanges = {'Position 0': np.arange(0.5,1.0,0.1), 'Position 1': np.arange(0.3,0.8,0.05),
        'Position 2': np.arange(0.25,0.75,0.05), 'Position 3': np.arange(0.2,0.7,0.05)}
BkgMeanRanges = {'Position 0': np.arange(0.13,0.18,0.005), 'Position 1': np.arange(0.04,0.080,0.005),
        'Position 2': np.arange(0.04, 0.080,0.005), 'Position 3': np.arange(0.04,0.080,0.005)}

#Some good starting efficiency ranges; these ranges were seen in the first analysis
#NEffRanges = {'Position 0': np.arange(0.62,0.72,0.01), 'Position 1': np.arange(0.52,0.61,0.01),
#        'Position 2': np.arange(0.42, 0.50, 0.01), 'Position 3': np.arange(0.32,0.40, 0.01)}
#GEffRanges = {'Position 0': np.arange(0.5,1.0,0.05), 'Position 1': np.arange(0.3,0.8,0.05),
#        'Position 2': np.arange(0.25,0.75,0.05), 'Position 3': np.arange(0.2,0.7,0.05)}
#BkgMeanRanges = {'Position 0': np.arange(0.13,0.16,0.0025), 'Position 1': np.arange(0.04,0.080,0.005),
#        'Position 2': np.arange(0.04, 0.080,0.005), 'Position 3': np.arange(0.04,0.080,0.005)}
